...
urlpatterns = patterns('stock_analysis.views',
    ...
    (r'^get_year_performance_per_share_table/$', 'get_performance_per_share_table', {'time_type': 'year'}),
    (r'^get_season_performance_per_share_table/$', 'get_performance_per_share_table', {'time_type': 'season'}),
    ...
    (r'^get_year_profitability_table/$', 'get_year_profitability_table'),
    (r'^get_season_roe_roa_table/$', 'get_roe_roa_table', {'time_type': 'season'}),
    (r'^get_year_roe_roa_table/$', 'get_roe_roa_table', {'time_type': 'year'}),
    (r'^get_season_current_ratio_table/$', 'get_season_current_ratio_table'),
    (r'^get_season_debt_ratio_table/$', 'get_season_debt_ratio_table'),
    
    (r'^get_season_performance_per_share_chart/$', 'get_performance_per_share_chart', {'time_type': 'season'}),
    (r'^get_year_performance_per_share_chart/$', 'get_performance_per_share_chart', {'time_type': 'year'}),
    ...
    (r'^get_year_profitability_chart/$', 'get_year_profitability_chart'),
    (r'^get_season_roe_roa_chart/$', 'get_roe_roa_chart', {'time_type': 'season'}),
    (r'^get_year_roe_roa_chart/$', 'get_roe_roa_chart', {'time_type': 'year'}),
